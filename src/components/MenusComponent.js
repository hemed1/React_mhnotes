      ...
      <nav className="navbar">
            ...
            <ul className="nav-menu">
                ...
                <li key='2'className="nav-item">
                    <a key={2} href="#services" className={`has-children ${(selectedCode === 2) ? "active" : ""}`} onClick={(e) => setSelectedCode(2)}>נתונים</a>
                    {/* <!-- Level 1 Dropdown --> */}
                    <ul className="submenu">
                        <li>
                            <a href="#web-design" onClick={(e) => setSelectedCode(2)}>ניהול נתונים</a>
                            {/* { 
                                //(isMenuOpen1 && ( 
                        ...
                        <li>
                            ...
                            <ul className="submenu">
                                <li><a key={21} className='has-children' href="#frontend" onClick={(e) => setSelectedCode(21)}>Frontd</a></li>
